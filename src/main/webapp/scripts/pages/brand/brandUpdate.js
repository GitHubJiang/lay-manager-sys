...
$(function(){
	...
	$("#brandSubmit").on("click", function() {			
		...
		for(var i=0 ;i<trList.length;i++){
			...
			var channelId = tdArr.eq(0).find("input[name=channelId]").val();
			...
			channelInfo = channelInfo + channelId +";"+ channelCode+";"+channelName+";"+sourceSys+";"+isDefault+"#";
		}
	...
	$("#lineAdd").on("click", function() {		
		var trHtml = "<tr><td class='text-center'><div class='row'><div class='col-sm-12'><div class='col-sm-1'></div><div class='form-group col-sm-10'>" 
			+"<input type='hidden' name='channelId' value=''><input type='text' name='channelCode' class='form-control' required>"
