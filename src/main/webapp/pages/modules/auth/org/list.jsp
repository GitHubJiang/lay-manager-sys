		...
		<div class="col-md-12  portlets">
			<div class="widget">
				<div class="widget-content padding">
					<div class="row">
						<div class="col-md-12">
							<form id="queryForm" method="post" role="form" action="${staticbase}/auth/org/list">
									...
									<table class="table table-hover" id="treeTable" data-form="queryForm" data-sortable data-sortable-type="server" 
										...
										<thead>
											<tr class="sort-header">
												<th data-sortable="false" width="15%">组织名称</th>
												<th data-sortable="false" width="15%">组织编码</th>
												<th data-sortable="false" width="15%">组织类型</th>
												<th data-sortable="false" width="15%">状态</th>
										...
										<tbody id="treeTableList">
											<c:forEach items="${list }" var="item">
												<c:if test="${item.parentUnitId==null }">
													<tr id="${item.id}">												
												...
												<c:if test="${item.parentUnitId!=null }">
													<tr id="${item.id}" pid="${item.parentUnitId }">												
														<td>${item.name }</td>
														<td>${item.code }</td>
														<td>${item.ouTypeName }</td>
														<td>${item.lifecycle }</td>
...
<script src="${staticbase }/scripts/pages/auth/org/list.js?${version}"></script>
