					...
					<div class="col-md-12  portlets">
						<div class="widget-newall">
							...
							<div class="widget widget-content padding">
								<div class="row">
									<div class="col-md-12"> 
										<form class="form-horizontal" role="form" data-toggle="form-validator" method="POST" action="${pagebase}/img/date/upload2" novalidate="true" enctype="multipart/form-data">
