				...
				<div class="row">
					<div class="col-md-12  portlets">
						<div class="widget-newall">
							<div class="row">
								<div class="col-md-4">
									<h3 class="marign-none">日期文件上传测试</h3>
								</div>
								<div class="col-md-8">
							...
							<div class="widget widget-content padding">
								<div class="row">
									<div class="col-md-12"> 
										<form class="form-horizontal" role="form" data-toggle="form-validator" method="POST" action="${pagebase}/file/date/upload2" novalidate="true" enctype="multipart/form-data">
