...
<div id="wrapper"> 
	...
	<jsp:include page="/pages/commons/common-left.jsp">
		<jsp:param name="pagecode" value="ACL_INV_INCR" />
	</jsp:include>
...
<div class="content">
	...
	<div class="col-md-8">
		<div class="toolbar-btn-action">	 
			<pri:add acl="ACL_INV_INCR"><a href="#" data-toggle="modal" data-target=".modal-import" class="btn btn-success btn-import"><i class="fa fa-plus-circle"></i>入库</a></pri:add>
	   		<pri:add acl="ACL_INV_INCR"><a href="#" data-toggle="modal" data-target=".modal-import" class="btn btn-success btn-import"><i class="fa fa-plus-circle"></i>出库</a></pri:add>
	   	</div>
	</div>
		...
		<div class="col-md-12  portlets">
			<div class="widget">
				<div class="widget-content padding">
					<div class="row">
						<div class="col-md-12">
							<form id="queryForm" method="post" role="form" action="${staticbase}/inv/invc/list">
...
<script src="${staticbase }/scripts/pages/inv/invclist.js?${version}"></script>
