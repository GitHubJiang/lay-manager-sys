...
import com.lay.shop.modules.sys.model.PriButton;


@MyBatisDao
public interface PriButtonDao extends BaseDao<PriButton,Long>{


	@QueryPage("findListCountByQueryMap")
	Pagination<PriButton> findListByQueryMapWithPage(Page page,Sort[] sorts,Map<String, Object> params);
